...
\item If a package fails to install, you may need to use ``sudo'': i.e., \texttt{sudo pip install --upgrade -f https://wxpython.org/Phoenix/snapshot-builds/ wxPython}.  You will then be asked for your computer password.
