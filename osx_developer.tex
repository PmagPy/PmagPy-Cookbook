...
\end{verbatim}
   \item Something happened in recent versions of pandas that breaks certain programs, so you need to downgrade your pandas installation:
\begin {verbatim}
conda install pandas version==1.2.5
\end{verbatim}
\item and now, activate your environment and finish installation
\begin {verbatim}
