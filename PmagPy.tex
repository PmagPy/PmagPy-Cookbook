...
\item Testing your installation:
  ...
  To make sure everything is working, return to your \href{#command_line}{command line}. OSX users, run the command

\begin{verbatim}
  eqarea.py -h
\end{verbatim}

  Windows users: you will need to use
...
Next, make sure the GUIs are working on the command line.
...
For Mac users with Anaconda Python:

\begin{verbatim}
  pmag_gui_anaconda
\end{verbatim}

For Mac users with a different Python:
...
This will open up a local IPython server in your default web browser. Click on \textit{Example_PmagPy_notebook.ipynb} to open and edit the main example notebook. You will see something like this:
