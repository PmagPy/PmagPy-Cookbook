...
\item Add PmagPy to your \$PATH by putting these lines to your .bashrc or .bash\_profile:
\begin{verbatim}
...
where *** is your username.  (Of course, these lines will depend on exactly where you have put your PmagPy folder -- if it lives on your Desktop, you will need to point your PATH there: \begin{verbatim}export PATH=/Users/***/Desktop/PmagPy/programs\end{verbatim}, and so on.)  Next, restart your Terminal.  At this point you should be able to use all PmagPy functionality as if you had done a full \href{#pip_install}{pip install}.  The only difference is that you will be able to stay up-to-date with PmagPy development and make edits in PmagPy code which will be immediately available in your system.
