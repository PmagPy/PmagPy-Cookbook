...
If you want to contribute to PmagPy or modify PmagPy programs for your own use, you should do a developer install.
\begin{enumerate}
...
\item Add PmagPy to your \$PATH by putting these lines to your .bashrc or .bash_profile:
\begin{verbatim}
...
If for some reason you don't install using pip, you can do a \href{#developer_install}{developer install}.
