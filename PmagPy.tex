...
You have a few options for downloading and using PmagPy.  If you only want to use the GUIs, you can download them as  \href{#standalone}{standalone programs}.
  If you want full access to PmagPy functionality, you must first install the recommended version of
   ...
   Then  \href{#pip_install}{use the pip utility} to download and install the {PmagPy} function library and the {PmagPy} command line programs or manually install by setting environment variables yourself.
...
Get started by downloading the zip file (see links below) and put the resulting folder wherever you wish. You will need to “extract all” files. Inside the PmagPy-Standalone folder you will find icons for installing Pmag GUI and MagIC GUI. Double click the program you wish to use and you will be guided the the install process.
...
\noindent You will find the latest stable release at: \href{https://github.com/PmagPy/PmagPy-Standalone-Linux}{https://github.com/PmagPy/PmagPy-Standalone-Linux}
...
\noindent Or if {\bf PmagPy} was properly installed and has been added to your PATH, you can simply type
