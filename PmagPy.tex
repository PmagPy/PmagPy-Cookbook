...
Under the Windows operating system, you will need to search for and open the ``cmd'' application. You'll use this for the ``pip install'' step of the PmagPy installation. However, after finishing the installation process (see: \href{#quick_start}{Installing PmagPy}), you will have a shortcut to the PmagPy command window on your desktop.  Double clicking on that will give you a window in which you can type {\bf PmagPy} commands.  You will use the PmagPy prompt instead of the Windows command line from there on.
