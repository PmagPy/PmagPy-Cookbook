...
\item \href{http://pmagpy.github.io/PmagPy.html#foldtest}{foldtest} and \href{http://pmagpy.github.io/PmagPy.html#foldtest_magic}{foldtest\_magic} : finds  tilt correction that maximizes concentration of directions, with bootstrap confidence bounds.
  \item \href{http://pmagpy.github.io/PmagPy.html#forc_diagram}{forc_diagram} : plots FORC diagrams for both conventional and irregular FORCs
...
\item \href{http://pmagpy.github.io/PmagPy.html#irm_unmix}{irm_unmix} : unmixes IRM acquisition data into dominant components
...
You can find a non-interactive page with information about each program on the \href{http://pmagpy.github.io/PmagPy.html}{{\bf PmagPy} Github page}.
...
Links to more information on to how to use the command line programs are given below. The example data files referred to in the following are located in the {\it data\_files} directory bundled with the {\bf PmagPy} software distribution.
...
You can find a non-interactive page with the same information on the \href{http://pmagpy.github.io/PmagPy-cli.html}{{\bf PmagPy} Github page}.
