...
\customlink{quick_start}
 ...
 \begin{enumerate}
 \item Download and install the {Enthought Python Distribution} (NOTE: the Enthought Academic Version has a problem with PmagPy that is begin fixed.  In the mean time, you can use this version:  
\begin{itemize}
...
\customlink{Datafiles}
 \url{http://earthref.org/PmagPy/Datafiles_2.0.zip} 
