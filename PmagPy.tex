...
You have a few options for downloading and using PmagPy.  If want to use the Pmag and MagIC GUIs, you can download both of them as  \href{#standalone}{standalone programs}. Note: the standalone functionality is only available for Mac users.
...
If you do not need the full PmagPy functionality, and you only want to use Pmag GUI, MagIC GUI, Thellier GUI, and Demag GUI, there is now a standalone download for you (available only for Mac users).  You won't need to install Python for this.
You can download the \href{https://github.com/PmagPy/PmagPy-Standalone-OSX/releases/latest}{standalone applications for OSX here}.
