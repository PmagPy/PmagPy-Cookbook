...
Use of the Thellier GUI is described in more detail in the \href{#thellier_GUI.py}{Thellier GUI} section below and in this PDF document: \href{https://github.com/PmagPy/PmagPy-Cookbook/raw/gh-pages/thellier_GUI_full_manual_1_0.pdf}{Thellier GUI manual}. Here are a few instructions that can be used as a quick start for using Thellier GUI.
...
\href{https://github.com/PmagPy/PmagPy/blob/master/programs/Thellier_GUI_tutorial.pdf}{[Thellier\_GUI\_tutorial.pdf]}
