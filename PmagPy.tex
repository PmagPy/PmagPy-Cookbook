...
First of all - how do you pronounce `NumPy'?  According to Important People at Enthought (e.g, Robert Kern) and the SciPy listserv, it should be pronounced ``Num'' as in ``Number'' and ``Pie'' as in, well, pie, or Python.  But it is also pretty fun to say Numpee!
