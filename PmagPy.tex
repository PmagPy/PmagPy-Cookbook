...
You can find a non-interactive page with information about each program on the \href{https://github.com/PmagPy/PmagPy/blob/master/PmagPy.ipynb}{{\bf PmagPy} Github page}.
