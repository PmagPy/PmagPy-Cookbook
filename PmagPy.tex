...
\item Open your Terminal and navigate to your PmagPy directory: \begin{verbatim}
  cd PmagPy
\end{verbatim}
...
\item Next, you need to add PmagPy to your PATH so that the PmagPy programs can be called from any directory. Run: \begin{verbatim}
  python dev_setup.py install
\end{verbatim} If you have problems with the install, run \verb!python dev_setup.py -h! for more information.
...
For Windows, the same variables are set but in your \href{https://www.java.com/en/download/help/path.xml}{Control Panel (Environment Variables)}.
