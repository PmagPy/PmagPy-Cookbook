...
\customlink{pip_install}
  ...
  To install using pip:
   ...
   \begin{itemize}
      ...
      \item Update pip: type on  the command line: \begin{verbatim}pip install --upgrade pip setuptools\end{verbatim}
     ...
     \item If you are getting weird install errors, try this: \texttt{pip install pmagpy --upgrade --no-deps --force-reinstall --no-cache-dir}
   \end{itemize}
...
To make sure everything is working, return to your \href{#command_line}{command line}, type \texttt{eqarea.py -h}.      Important note for Windows users: you will need to use \texttt{eqarea -h}  In fact, you will drop the ``.py'' anytime you are calling a command-line program.

 If you do not see the help message, check the \href{#trouble}{Trouble Shooting} section. If you don't find a solution there, please send the error message and  the Python distribution you are using, including the version number, to \href{mailto:ltauxe@ucsd.edu?subject=PmagPy Cookbook}{ltauxe@ucsd.edu}
