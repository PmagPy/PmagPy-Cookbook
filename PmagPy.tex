...
\customlink{quick_start}
 ...
 To skip all the details and just start using MagIC.py to upload data into the \href{#MagICDatabase}{MagIC database}, you follow these steps:
...
\begin{itemize}
\item \href{#QuickMagIC.py}{Analyze my demagnetization and/or paleointensity measurement data. }
...
\chapter{QuickMagIC.py}
\label{chap:QuickMagIC}\href{#QuickMagic}{[QuickMagIC]}

{\bf QuickMagIC.py} is a blah blah.    
...
\href{#MagICDatabase}{[MagIC Database]} and   \href{http://earthref.org/PmagPy/hires.html}{high resolution instructions}
